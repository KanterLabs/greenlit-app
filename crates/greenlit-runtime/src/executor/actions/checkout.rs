...
mod tests {
    ...
    fn base64_matches_known_vectors() {
        assert_eq!(
            base64_basic("x-access-token:abc"),
            "eC1hY2Nlc3MtdG9rZW46YWJj"
        );
        assert_eq!(base64_basic(""), "");
        assert_eq!(base64_basic("f"), "Zg==");
        assert_eq!(base64_basic("fo"), "Zm8=");
        assert_eq!(base64_basic("foo"), "Zm9v");
    }

    #[test]
    fn workspace_relative_and_absolute_paths_join_correctly() {
        assert_eq!(join_workspace("/ws", "extra"), "/ws/extra");
        assert_eq!(join_workspace("/ws/", "extra"), "/ws/extra");
        assert_eq!(join_workspace("/ws", "/abs/other"), "/abs/other");
    }
    ...
    #[test]
    fn refs_prefixes_are_stripped_for_fetch() {
        assert_eq!(strip_refs_prefix("refs/heads/main"), "main");
        assert_eq!(strip_refs_prefix("refs/tags/v1"), "v1");
