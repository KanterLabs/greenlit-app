...
- Validate the Linux x86_64 host before engine work. Map `ubuntu-latest`, `ubuntu-24.04`, `ubuntu-22.04`, and both KanterLabs homelab tiers; `ubuntu-latest`, `homelab`, and `homelab-heavy` use 24.04 in v0.
